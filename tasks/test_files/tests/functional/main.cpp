...
#include "test_files/mpi/include/ops_mpi.hpp"
#include "test_files/seq/include/ops_seq.hpp"
...
const auto kTestTasksList = std::tuple_cat(
    ppc::util::AddFuncTask<KotelnikovaAConvexHullForBinImgMPI, InType>(kTestParam, PPC_SETTINGS_test_files),
    ppc::util::AddFuncTask<KotelnikovaAConvexHullForBinImgSEQ, InType>(kTestParam, PPC_SETTINGS_test_files));
