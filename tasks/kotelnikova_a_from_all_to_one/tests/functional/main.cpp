...
class KotelnikovaAFuncTestsProcesses2 : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 ...
 protected:
  void SetUp() override {
    ...
    {
      std::string abs_path = ppc::util::GetAbsoluteTaskPath(PPC_ID_kotelnikova_a_from_all_to_one, "pic.jpg");
...
TEST_P(KotelnikovaAFuncTestsProcesses2, MatmulFromPic) {
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<KotelnikovaAFromAllToOneMPI, InType>(kTestParam, PPC_SETTINGS_kotelnikova_a_from_all_to_one),
...
INSTANTIATE_TEST_SUITE_P(PicMatrixTests, KotelnikovaAFuncTestsProcesses2, kGtestValues, kPerfTestName);
