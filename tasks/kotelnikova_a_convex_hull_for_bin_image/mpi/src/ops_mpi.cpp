...
void KotelnikovaAConvexHullForBinImgMPI::ReceiveHullsFromProcess(int source_rank, int hull_count) {
...
void KotelnikovaAConvexHullForBinImgMPI::SendHullsToRank0() {
