...
- `IsSentenceEnd()`, `IsWordCharacter()` - вспомогательные проверки;
...
|-------------|-------|---------|---------|------------|
| seq         | 1     | 0.0179  | 1.00    | N/A        |
| mpi         | 2     | 0.0087  | 2.06    | 102,87%    |
| mpi         | 4     | 0.0051  | 3.51    | 87,75%     |
| mpi         | 6     | 0.0049  | 3.65    | 60,88%     |

Анализ результатов:
- Хорошее ускорение - до 3.65 раз на 6 процессах
- Высокая эффективность на 2 и 4 процессах (>85%)
- Снижение эффективности на 6 процессах (61%) - происходит из-за накладных расходов MPI
